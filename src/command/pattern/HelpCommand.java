...
public class HelpCommand implements Command {
    ...
    private static final String WITHDRAW_MONEY_EXAMPLE = "$ withdraw-money <amount>" + System.lineSeparator();
    ...
    private static final String HELP_MESSAGE =
        "You can choose from the following commands:" + System.lineSeparator() +
            REGISTER_EXAMPLE + LOGIN_EXAMPLE + LOGOUT_EXAMPLE + DEPOSIT_MONEY_EXAMPLE + WITHDRAW_MONEY_EXAMPLE +
            LIST_OFFERINGS_EXAMPLE + BUY_EXAMPLE + SELL_EXAMPLE + GET_WALLET_SUMMARY_EXAMPLE +
            GET_WALLET_OVERALL_SUMMARY_EXAMPLE + DISCONNECT_MESSAGE +
